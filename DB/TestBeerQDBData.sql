...
-- -----------------------------------------------------
-- Data for table `bar_owner`
-- -----------------------------------------------------
START TRANSACTION;
USE `beerqdb`;
INSERT INTO `bar_owner` (`bar_id`, `user_id`) VALUES (1, 1);
...
START TRANSACTION;
USE `beerqdb`;
INSERT INTO `beer` (`id`, `style`, `name`, `abv`, `brewery_id`, `description`) VALUES (1, 'IPA', 'The IPA', '7.8', 1, 'hoppy');
